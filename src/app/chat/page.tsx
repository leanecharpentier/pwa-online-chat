    ...
    const initCamera = async () => {
      ...
      try {
        ...
        while (!videoRef.current && attempts < 20) {
          ...
          attempts++;
          console.log(
            `Tentative ${attempts}/20 - videoRef.current:`,
            videoRef.current
          );
        }
  ...
  const capturePhoto = () => {
    if (videoRef.current && canvasRef.current) {
      ...
      if (video.readyState < 2) {
        console.warn(
          "La vidéo n'est pas encore prête, readyState:",
          video.readyState
        );
      ...
      if (context) {
        ...
        console.log(
          "Photo capturée - Taille data URL:",
          imageDataUrl.length,
          "caractères"
        );
  ...
  const sendPhoto = () => {
    if (capturedImage) {
      ...
      try {
        ...
        console.log(
          "Photo sauvegardée avec succès. Total photos:",
          photos.length
        );
