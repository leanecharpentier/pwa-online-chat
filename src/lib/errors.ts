...
export const ErrorMessages = {
  SOCKET_NOT_INITIALIZED:
    "Erreur: socket non initialisé. Veuillez rafraîchir la page.",
  SOCKET_NOT_CONNECTED:
    "Erreur: socket non connecté. Veuillez attendre la connexion.",
  SOCKET_ID_UNAVAILABLE:
    "Erreur: socket ID non disponible. Veuillez réessayer.",
